...
class BamlStreamClient {
  ...
  MakeClassWithDone(
      ...
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<ClassWithDone>, ClassWithDone> {
    try {
      const raw = this.runtime.streamFunction(
        "MakeClassWithDone",
        {
      ...
      return new BamlStream<RecursivePartialNull<ClassWithDone>, ClassWithDone>(
        raw,
        (a): a is RecursivePartialNull<ClassWithDone> => a,
