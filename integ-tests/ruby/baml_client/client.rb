  ...
  class BamlClient
    ...
    sig {
      params(
        ...
        baml_options: T::Hash[Symbol, T.any(Baml::TypeBuilder, Baml::ClientRegistry)]
      ).returns(Baml::Types::ClassWithDone)
    }
    def MakeClassWithDone(
      ...
      if varargs.any?
        ...
        raise ArgumentError.new("MakeClassWithDone may only be called with keyword arguments")
      end
      if (baml_options.keys - [:client_registry, :tb]).any?
        raise ArgumentError.new("Received unknown keys in baml_options (valid keys: :client_registry, :tb): #{baml_options.keys - [:client_registry, :tb]}")
      end
  ...
  class BamlStreamClient
    ...
    sig {
      params(
        ...
        baml_options: T::Hash[Symbol, T.any(Baml::TypeBuilder, Baml::ClientRegistry)]
      ).returns(Baml::BamlStream[Baml::Types::ClassWithDone])
    }
    def MakeClassWithDone(
        *varargs,
      ...
      Baml::BamlStream[Baml::PartialTypes::ClassWithDone, Baml::Types::ClassWithDone].new(
        ffi_stream: raw,
        ctx_manager: @ctx_manager
      )
    end
