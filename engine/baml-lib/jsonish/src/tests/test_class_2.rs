  ...
  r#"
{
  ...
  "#,
  FieldType::Class("PageTask".to_string(), TypeMetadata::default()),
  {
    "type": "page",
    "name": "HomePage",
    "description": "Landing page with post list",
...
test_deserializer!(
  ...
  FieldType::union(vec![
    FieldType::Class("ServerActionTask".to_string(), TypeMetadata::default()),
    FieldType::Class("PageTask".to_string(), TypeMetadata::default()),
    FieldType::Class("ComponentTask".to_string(), TypeMetadata::default()),
  ]).as_list(),
  [
    {
      "type": "server_action",
