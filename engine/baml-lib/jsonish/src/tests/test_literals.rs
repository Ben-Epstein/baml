...
test_deserializer!(
    ...
    EMPTY_FILE,
    "2",
    FieldType::Literal(LiteralValue::Int(2), TypeMetadata::default()),
    2
);
...
test_deserializer!(
    ...
    EMPTY_FILE,
    "-42",
    FieldType::Literal(LiteralValue::Int(-42), TypeMetadata::default()),
    -42
);
...
test_deserializer!(
    ...
    EMPTY_FILE,
    "0",
    FieldType::Literal(LiteralValue::Int(0), TypeMetadata::default()),
    0
);
...
test_deserializer!(
    ...
    EMPTY_FILE,
    "true",
    FieldType::Literal(LiteralValue::Bool(true), TypeMetadata::default()),
    true
);
...
test_deserializer!(
    ...
    EMPTY_FILE,
    "false",
    FieldType::Literal(LiteralValue::Bool(false), TypeMetadata::default()),
    false
);
...
test_deserializer!(
    ...
    EMPTY_FILE,
    r#""TWO""#,
    FieldType::Literal(LiteralValue::String("TWO".into()), TypeMetadata::default()),
    "TWO"
);
...
test_deserializer!(
    ...
    FieldType::Union(vec![
        FieldType::Literal(LiteralValue::Int(2), TypeMetadata::default()),
        FieldType::Literal(LiteralValue::Int(3), TypeMetadata::default()),
...
test_deserializer!(
    ...
    FieldType::Union(vec![
        FieldType::Literal(LiteralValue::String("TWO".into()), TypeMetadata::default()),
        FieldType::Literal(LiteralValue::String("THREE".into()), TypeMetadata::default()),
    ], TypeMetadata::default()),
    "TWO"
);
